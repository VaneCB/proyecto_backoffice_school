                ...
                <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                    <div class="card card-plain mt-8">
                        <div class="card-header pb-0 text-left bg-transparent">
                          <h3 class="font-weight-bolder text-info text-gradient">{{ __('Escuela Inventada') }}</h3>
                            {{--<img src="../assets/img/persuasion-logo.png" class="navbar-brand-img h-200" style="width:200px" alt="...">
                        ...
                        <div class="card-body">
                            <form wire:submit.prevent="login" action="#" method="POST" role="form text-left">
                                ...
                                <div class="text-center">
                                    <button type="submit"
                                        class="btn bg-gradient-info w-100 mt-4 mb-0">{{ __('Conectarse') }}</button>
                                </div>
                            </form>
                            <br>
