            ...
            <table class="table align-items-center mb-0">
                ...
                @foreach($group->transactionLines as $l)
                    ...
                    <tr>
                        ...
                        <td>
                            <p class="text-xs font-weight-bold mb-0">{{ $l->tax }}€</p>
                        </td>
                        <td>
                            <p class="text-xs font-weight-bold mb-0">{{ $l->price + $l->tax }}€</p>
                        </td>
                        <td>
...
@if($this->isShow ==false)
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input wire:model="lineData.{{ $l->id }}.quantity" class="form-control" type="text"
                                           placeholder="cantidad" id="transactionLines-quantity">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="transactionLines-new_contracts" class="form-control-label">Nuev.
                                        Contratos</label>
                                    <input wire:model="lineData.{{ $l->id }}.new_contracts" class="form-control"
                                           type="text" placeholder="Contratos" id="transactionLines-new_contracts">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input value="{{$this->getPriceContractsEdit($l->id) ?? 0}}" class="form-control"
                                           type="text" placeholder="Contratos" id="transactionLines-new_contracts_price" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input value="{{ $this->calculateTotalHoursEdit($l->id) }}" class="form-control"
                                           type="text"
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="transactionLines-tax" class="form-control-label">Tipo de IVA</label>
                                    <select wire:model="lineData.{{ $l->id }}.selectedTax" class="form-control"
                                            id="transactionLines-taxType">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="transactionLines-tax" class="form-control-label">IVA</label>
                                    <input value="{{$this->calculateTaxEdit($l->id)}}" class="form-control"
                                           type="text"
                                           placeholder="IVA"
                                           id="transactionLines-tax" readonly>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="transactionLines-price" class="form-control-label">€/H</label>
                                    <input value="{{ $this->getPriceForSelectedProductVariationEdit($l->id) }}"
                                           class="form-control"
                                           type="text"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input value="{{ $this->totalLineTaxEdit($l->id) }}" class="form-control" type="text"
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn bg-gradient-dark"
                                    wire:click="updateTransactionLineInvoice({{$l->id}})"
                                    data-bs-dismiss="modal">
                                Actualizar
                            </button>
                        </div>
    ...
    @foreach($this->lineGroups as $group)
        <div wire:ignore.self class="modal fade" id="editTransactionLineGroupModal_{{$group->id}}" tabindex="-1"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input wire:model="groupTitle.{{$group->id}}" class="form-control"
                                           type="text"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input wire:model="groupSubtitle.{{$group->id}}" class="form-control"
                                           type="text"
                                           placeholder="{{$group->subtitle}}"
                                           id="transactionLinesGroups-subtitle">
                                </div>
                            </div>
                        </div>
                    </div>
