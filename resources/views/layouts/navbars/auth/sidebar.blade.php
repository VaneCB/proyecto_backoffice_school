        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                ...
                <div
                        class="icon icon-shape icon-sm shadow border-radius-md text-center me-2 d-flex align-items-center justify-content-center"
                        style="background: white">
                    <!-- Ícono SVG de Font Awesome -->
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="fa-2x" aria-hidden="true" focusable="false">
                        <path fill="currentColor" d="M256 0c70.7 0 128 57.3 128 128s-57.3 128-128 128S128 198.7 128 128 185.3 0 256 0zm0 192c35.3 0 64-28.7 64-64s-28.7-64-64-64-64 28.7-64 64 28.7 64 64 64zM256 256c-70.7 0-128 57.3-128 128v32h256v-32c0-70.7-57.3-128-128-128z"/>
                    </svg>
                </div>
            ...
            <li class="nav-item pb-2">
                ...
                <div class="icon icon-shape icon-sm shadow border-radius-md text-center me-2 d-flex align-items-center justify-content-center" style="background: white">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" height="1em">
                        <path d="M464 0H48C21.5 0 0 21.5 0 48V464C0 490.5 21.5 512 48 512H464C490.5 512 512 490.5 512 464V48C512 21.5 490.5 0 464 0zM224 480H288C303.6 480 318.3 474.3 328.6 463.4L442.6 335.4C453.7 325.1 459.7 308.1 459.7 291.5C459.7 275.5 453.3 258.9 442.1 249.2L360.3 173.6C357.5 168.8 352.5 164.8 346.8 162.7L238.6 105.3C232.9 102.8 226.5 103.3 221.8 106.7L174.5 132.4L207.4 156.8C212.7 160.3 215.7 166.7 215.7 173.6V238.4C215.7 246.4 221.8 252.6 229.8 252.6H282.2C290.2 252.6 296.3 246.4 296.3 238.4V173.6C296.3 167.6 300.3 161.3 306.9 158.4L358.6 130.2C365.2 127.3 374.4 128.4 380.2 134L437.7 209.6C441.9 215.9 444.6 224.5 444.6 233.5C444.6 241.7 441.9 249.8 437.7 255.7L328.7 319.8C324.4 325.1 317.2 327.2 310.2 327.2H201.8C194.8 327.2 187.6 325.1 183.3 319.8L74.3 255.7C70.1 249.8 67.4 241.7 67.4 233.5C67.4 224.5 70.1 215.9 74.3 209.6L131.7 134C137.5 128.4 146.7 127.3 153.3 130.2L205 158.4C211.7 161.3 215.7 167.6 215.7 173.6V238.4C215.7 246.4 221.8 252.6 229.8 252.6H282.2C290.2 252.6 296.3 246.4 296.3 238.4V173.6C296.3 167.6 300.3 161.3 306.9 158.4L358.6 130.2C365.2 127.3 374.4 128.4 380.2 134L437.7 209.6C441.9 215.9 444.6 224.5 444.6 233.5C444.6 241.7 441.9 249.8 437.7 255.7zM192 352H320C327.2 352 334.1 356.6 335.7 364.1L342.1 414.1C343.8 421.4 338.8 428.8 332.4 431.7L232.4 483.7C223.3 491.9 210.7 491.9 201.6 483.7L101.6 431.7C95.2 428.8 90.2 421.4 91.9 414.1L98.3 364.1C99.9 356.6 106.8 352 114 352z"/>
                    </svg>
                </div>
            ...
            <li class="nav-item pb-2">
                ...
                <span class="nav-link-text ms-1 text-dark">Extraescolares</span>
                </a>
            </li>
            <li class="nav-item pb-2">
                ...
                <div class="icon icon-shape icon-sm shadow border-radius-md text-center me-2 d-flex align-items-center justify-content-center" style="background: white">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" height="1em">
                        <path d="M480 448c0 35.3-28.7 64-64 64H96c-35.3 0-64-28.7-64-64V128c0-35.3 28.7-64 64-64h320c35.3 0 64 28.7 64 64v320zM336 304c0 26.5-21.5 48-48 48s-48-21.5-48-48 21.5-48 48-48 48 21.5 48 48zM224 160c35.3 0 64 28.7 64 64s-28.7 64-64 64-64-28.7-64-64 28.7-64 64-64zM464 64c-17.6 0-32 14.4-32 32v32H80V96c0-17.6-14.4-32-32-32C14.4 64 0 78.4 0 96v320c0 17.6 14.4 32 32 32h448c17.6 0 32-14.4 32-32V96c0-17.6-14.4-32-32-32z"/>
                    </svg>
                </div>
